package io.haeng.covid19tracker.services;
...
public class CovidDataService {
    ...
    @PostConstruct
    @Scheduled(cron = "* * 1 * * *") // (cron = "second minute hour day month year")
...
//            locationStats.setDiffFromPrevDay(latestCases - prevDayCases);
            locationStats.intToString_latest(latestCases);
            locationStats.intToString_diff(latestCases - prevDayCases);
